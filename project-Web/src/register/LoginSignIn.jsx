...
const LoginSignIn = () => {
    ...
    const [isLogggedIn,setIsLoggedIn] = useState(!!localStorage.getItem("user"));
            ...
            <div className='section-container'>
                <div className='background'>
                    <div className='heading-nav'>
                        ...
                        <p>Bạn chưa có tài khoản ? Đăng ký 
                             <Link to ="/Register" style={{marginLeft: "4px"}}>tại đây</Link>
                        </p>
                    </div>
                    ...
                    <form className='inputs' onSubmit = {onFinish}>
                        ...
                        <button  type="submit" style={{outline: "none", border: "none"}} className='submit-container'>Đăng Nhập</button>
                    </form>
